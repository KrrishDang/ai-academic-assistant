            ...
            {availableThemes.map((t) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="w-full h-10 rounded-lg flex flex-col p-1.5 gap-0.5 relative overflow-hidden border border-black/10"
                  ...
                  <span className="text-[9px] font-bold truncate w-full text-foreground">
                    {t.name}
                  </span>
                </button>
              );
